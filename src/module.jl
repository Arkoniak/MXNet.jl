...
type BaseModule <: AbstractModule
  ...
  BaseModel() = new(false, false, false, false, false)
end
...
"""
function iter_predict(self, eval_data, num_batch=None, reset=True):
  @assert self.binded && self.params_initialized
...
"""
function init_params!(mod, initializer=Uniform(0.01), arg_params=None, aux_params=None,
